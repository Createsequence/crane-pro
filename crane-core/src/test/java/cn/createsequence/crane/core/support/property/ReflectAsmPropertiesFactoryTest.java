...
/**
 * test for {@link ReflectAsmPropertiesFactory}
 *
 * @author huangchengxing
 */
public class ReflectAsmPropertiesFactoryTest {

    @Test
    public void createBeanProperty() {
        BeanPropertiesFactory factory = new ReflectAsmPropertiesFactory(new ClassCastConverter());
